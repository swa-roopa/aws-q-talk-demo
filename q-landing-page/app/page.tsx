  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Search"
              className="px-4 py-2 rounded-md w-64 text-gray-800"
            />
      ...
      <main className="flex-1 px-12 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-600 mb-6">
              We deliver high-performance Hydricylic Machines and Semiconductor
              tools, rigorously tested for industrial-grade durability and
              accuracy.
            </p>
          ...
          <div className="md:col-span-4 flex flex-col">
            ...
            <p className="text-gray-600 mb-6">
              Crafted with cutting-edge tech and strict quality controls, our
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-600 mb-6">
              Available across major metro cities, our solutions offer top
              quality at competitive prices—backed by expert support and
              warranty.
            </p>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          onClick={() => generateWebUrl()}
          className="bg-[#FF5A5F] text-white p-3 rounded-full shadow-lg hover:bg-[#FF4246] transition"
        >
